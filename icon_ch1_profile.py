...
FILE_LAST_HOUR = "ultima_ora_icon_ch1.txt"
FILENAME = "icon_ch1_profile.png"

# Regole fisse da tabella per ICON-CH1
RUN_DURATION = 33
START_DELAY = 1
...
def fetch_dati_con_retry() -> dict:
    ...
    headers = {"User-Agent": "MeteoBot-ICONCH1/3.0"}
...
def main():
    print("Scaricamento dati ICON-CH1 Ensemble Mean...")
    ...
    print(f"ℹ️ Trovato nuovo run ICON-CH1 {nome_run}. Generazione del grafico esatto...")
    ...
    titolo_in_basso = f"Modello MeteoSwiss ICON-CH1 Ensemble Mean ({lunghezza_effettiva}h)   |   Data e Ora (Fuso Orario Locale)"
    ...
    if token and chat_id:
        ...
        payload = {"chat_id": chat_id, "caption": f"ICON-CH1 ({nome_run})"}
