...
def fetch_dati_con_retry() -> dict:
    ...
    headers = {"User-Agent": "MeteoBot-AROME/3.0"}
...
def main():
    ...
    print(f"ℹ️ Trovato nuovo run AROME {nome_run}. Generazione grafico esatto...")
    ...
    titolo_in_basso = f"Modello MeteoFrance AROME ({lunghezza_effettiva}h)   |   Data e Ora (Fuso Orario Locale)"
    ...
    if token and chat_id:
        ...
        payload = {"chat_id": chat_id, "caption": f"AROME (2.5 km) ({nome_run})"}
